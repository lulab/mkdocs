...
* 2024	[**Molecular Cell**](https://doi.org/10.1016/j.molcel.2024.01.008) - Alternative polyadenylation determines the functional landscape of inverted Alu repeats
...
* 2021	**Nature Communications** - Conserved long-range base pairings are associated  with pre-mRNA processing of human genes
* **Long distance (>200nt) pairing**:   **SuperFold** for long distance base pairs (folding)  [2014 _Nature Methods_](https://www.ncbi.nlm.nih.gov/pubmed/25028896)
