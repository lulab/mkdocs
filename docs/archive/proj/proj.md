...
![](./img/projects.webp){: style="max-width:600px; " }
...
![](./img/research.webp){: style="max-width:600px; " }




### A1. [**dsRNA**] Double-stranded RNA (dsRNA) as Immune Regulator {#dsRNA}
...
![Different types of dsRNAs in immune response](./img/dsRNA.webp){: style="max-width:600px; " }
...
![Different NGS libraries of cfRNAs](./img/exRNA-seq.jpg){: style="max-width:600px; " }
...
![](./img/multiomics.webp){: style="max-height:300px; " }
...
![](./img/modeling.webp){: style="max-width:600px; " }
...
![](./img/RNA-Talk.webp){: style="max-width:600px; " }
...
![](./img/rna-structure-prediction.webp){: style="max-width:600px; " }
...
![](./img/drug_rna.webp){: style="zoom:20%;" }
